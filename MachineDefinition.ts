...
namespace MachineDefinition {
  ...
  export namespace StateNode {
    ...
    > =
      ...
      & { id?: Id.Of<Definition, L.Append<Path, "id">, Precomputed>
        ...
        , entry?: Entry.Of<Definition, L.Append<Path, "entry">, Precomputed>
        , __debugger?:
  ...
  export namespace Transition {
    ...
    export type Of<
        ...
        IsRedundant = MachineSnapshot.IsRedundantTransition<
          Definition, Precomputed, ReferencePathString.FromDefinitionPath<StateNodePath>, S.Assert<L.Last<Path>>
        >
      > =
  ...
  export namespace Always {
    ...
    export type Of<
        ...
        ReferencePathString =
          ...
          | ( StateNodePath["length"] extends 0 ? never : keyof O.Path<Definition, L.Pop<StateNodePath>> ),
        IsRedundant = MachineSnapshot.IsRedundantTransition<
            Definition, Precomputed, ReferencePathString.FromDefinitionPath<StateNodePath>, Always.$$Event>
      > =
  ...
  namespace MachineSnapshot {
    ...
    export type Transition<
      Definition extends A.Object,
      Precomputed extends A.Object,
      InitialStateReferencePathString extends A.String,
      Event extends A.String | Always.$$Event | null,

      VisitedStateReferencePathStrings extends A.Tuple<A.String> = [],
      InitialStateNode extends A.Object = O.Assert<O.Path<Definition, ReferencePathString.ToDefinitionPath<InitialStateReferencePathString>>>,
      ...
      TransitionMap = Precomputed.Get<Precomputed, "StaticTransitionMap">,
      EventMap = O.Prop<TransitionMap, InitialStateReferencePathString>,
      IsVisited = L.Includes<VisitedStateReferencePathStrings, InitialStateReferencePathString>,
      NextVisitedStateReferencePathString extends A.Tuple<A.String> =
        L.Append<VisitedStateReferencePathStrings, InitialStateReferencePathString>
    > =
          ...
          ? U.ListOf<keyof ChildStates> extends infer NextStates
            ? { [K in keyof NextStates]:
                  Transition<
                    Definition,
                    Precomputed, 
                    InitialStateReferencePathString extends ""
                      ? S.Assert<NextStates[K]>
                      : `${InitialStateReferencePathString}.${S.Assert<NextStates[K]>}`,
                    null,
                    NextVisitedStateReferencePathString
                  >
              }
            : never
          : InitialStateReferencePathString :
      Event extends null
        ? ( Always.$$Event extends keyof EventMap
              ? Transition<
                  ...
                  InitialStateReferencePathString,
                  Always.$$Event,
                  VisitedStateReferencePathStrings
                > :
            ...
            Transition<
              ...
              InitialStateReferencePathString extends ""
                ? S.Assert<Initial>
                : `${InitialStateReferencePathString}.${S.Assert<Initial>}`,
              null,
              NextVisitedStateReferencePathString
            >
          ) 
              ...
              EventMap[Event] extends infer NextState
                ? NextState extends any 
                  ? (NextState extends A.Tuple<A.String> ? NextState : [NextState]) extends infer NextStates
                    ? { [K in keyof NextStates]:
                        Transition<Definition, Precomputed, S.Assert<NextStates[K]>, null, NextVisitedStateReferencePathString>
    ...
    > = Transition<D, Precomputed.Of<D>, I, E>
    ...
    export type IsRedundantTransition<
      ...
      Event extends A.String | Always.$$Event | null
    > =
      A.String extends InitialStateReferencePathString ? B.Boolean :
      A.Equals<
        InitialStateReferencePathString,
        Transition<Definition, Precomputed, InitialStateReferencePathString, Event>
      >
    ...
    export type TestIsRedundantTransition<
      ...
      InitialStateReferencePathString extends A.String,
      Event extends A.String | Always.$$Event | null
    > = IsRedundantTransition<Definition, Precomputed.Of<Definition>, InitialStateReferencePathString, Event>
  ...
  export namespace TransitionMap {
    export type Of<
      ...
      StaticMap = Precomputed.Get<Precomputed, "StaticTransitionMap">
    > =
      { [State in keyof StaticMap]:
          { [Event in keyof StaticMap[State]]:
              MachineSnapshot.Transition<
                Definition, Precomputed, S.Assert<State>, A.Cast<Event, A.String | Always.$$Event>
              >
          }
      }
  }
  ...
  export namespace Entry {
    export type Of<
      ...
      Self = O.Assert<O.Path<Definition, Path>>,
      StateReferencePathString extends A.String = ReferencePathString.FromDefinitionPath<L.Pop<Path>>,
      TransitionMap = Precomputed.Get<Precomputed, "TransitionMap">,
      EventIdentifier = U.Exclude<{ [State in keyof TransitionMap]:
        { [Event in keyof TransitionMap[State]]:
          StateReferencePathString extends TransitionMap[State][Event]
            ? Event
            : never
